...
% Creating y (each row is an example of one y value)
...
for t = 1:m
    ...
    % Calculating delta 2
    delta_2 = (transpose(Theta2) * delta_3) .* sigmoidGradient([1; z_2]);
...
% Obtaining unregularized gradient
Theta1_grad = (1/m) * Theta1_grad;
Theta2_grad = (1/m) * Theta2_grad;

% Regularized gradient
Theta1_reg_term = (lambda/m) * [zeros(size(Theta1, 1), 1) Theta1(:, 2:end)];
Theta2_reg_term = (lambda/m) * [zeros(size(Theta2, 1), 1) Theta2(:, 2:end)];
